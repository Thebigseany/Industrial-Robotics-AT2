...
f_1 = PlaceObject('fence.ply',[-0.2,1.1,0.15,0,0,0]);
f_2 = PlaceObject('fence.ply',[0.5,1.1,0.15,0,0,0]);
f_3 = PlaceObject('fence.ply',[-0.2,-1.1,0.15,0,0,0]);
f_4 = PlaceObject('fence.ply',[0.5,-1.1,0.15,0,0,0]);
cone_1 = PlaceObject('cone.ply',[1.3,-0.4,0,0,0,0]);
cone_2 = PlaceObject('cone.ply',[1.3,0.4,0,0,0,0]);
