...
cart1 = PlaceObject('cart.ply',[0.7,-0.15,0.15,0,0,0]);
...
brickDropoff = {
    [0.52, 0, 0.25];  % First brick dropoff position (adjust Z-coordinate as needed)
    [0.42, 0, 0.25];  % Adjust Z-coordinate
    [0.3, 0, 0.25];   % Adjust Z-coordinate
    [0.5, 0, 0.3];    % Adjust Z-coordinate
    [0.4, 0, 0.3];    % Adjust Z-coordinate
    [0.3, 0, 0.3];    % Adjust Z-coordinate
    [0.5, 0, 0.35];   % Adjust Z-coordinate
    [0.4, 0, 0.35];   % Adjust Z-coordinate
    [0.3, 0, 0.35];   % Adjust Z-coordinate
};
