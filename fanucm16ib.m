classdef fanucm16ib < RobotBaseClass
    %% SchunkUTSv2
    ...
    properties(Access = public)   
        plyFileNameStem = 'fanucm16ib'; % Options: (-) SchunkUTSv2, (-) SchunkUTSv2EndEffectorNozzleNoSensor, (-) SchunkUTSv2EndEffectorPlate'
    end

    methods (Access = public) 
%% Constructor
        function self = fanucm16ib(baseTr)
			self.CreateModel();
